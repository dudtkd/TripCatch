...
Integer logCount = (Integer)session.getAttribute("logCount");
Integer comCount = (Integer)session.getAttribute("comCount");
...
<div id="my_sidebar" class="my_sidebar">
	...
	<%
		...
		if(mv == null && (logCount == null || logCount.intValue() == 0)){
	...
	<hr>
	<span class="plc">여행일정 1개&nbsp;&nbsp;&nbsp;여행기록 <%=logCount%> 개&nbsp;&nbsp;&nbsp;커뮤니티 <%=comCount%> 개</span>
	<%
